...
class LoginController extends Controller {
	...
	public function __construct(?string $appName,
								...
								ILoggerCollector $loggerController) {
...
/**
	...
	//	}
		...
		if (!$result->isSuccess()) {
			$this->loggerController->collector("Login failed","Login failed user=".trim($user),"LOGIN");
		...
		else
		{
			...
			if (!empty($addressId)) {
				$this->loggerController->collector("Login successful","Login successful user=".trim($user),"LOGIN");
			}
		}
