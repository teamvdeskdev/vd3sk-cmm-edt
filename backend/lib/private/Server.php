...
class Server extends ServerContainer implements IServerContainer {
	...
	public function __construct($webRoot, \OC\Config $config) {
		...
		$this->registerService(\OC\LogCollector::class, function (Server $c) {
			$logType = $c->query('AllConfig')->getSystemValue('log_type', 'file_collector');
			$factory = new LogFactory($c, $this->getSystemConfig());
			 
			$logger = $factory->get($logType);
			$registry = $c->query(\OCP\Support\CrashReport\IRegistry::class);

			return new LogCollector($logger, $this->getSystemConfig(), null, $registry);
		});

		$this->registerAlias(\OCP\ILoggerCollector::class, \OC\LogCollector::class);
		$this->registerAlias('LoggerCollector', \OC\LogCollector::class);
...
/**
	 * Returns a logger instance
	 *
	 * @return \OCP\ILoggerCollector
	 */
	public function getLoggerCollector() {
		return $this->query('LoggerCollector');
	}
