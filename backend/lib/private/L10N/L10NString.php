...
class L10NString implements \JsonSerializable {
	...
	public function __toString() {
		...
		$text = str_ireplace('href="https://github.com/nextcloud/server/issues"', 'href="mailto:support@liveboxcloud.com"', $text);
		$text = str_ireplace('https://github.com/nextcloud/server/issues', 'support@liveboxcloud.com', $text);
		$text = str_ireplace('nextcloud', 'Drive', $text);
