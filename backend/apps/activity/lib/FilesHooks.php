...
class FilesHooks {
    ...
    /** @var ILoggerCollector */
    protected $loggerCollector;
	/**
	 * Constructor
	 *
	 ...
	 * @param ILoggerCollector $loggerCollector
	 */
	public function __construct(IManager $manager,
								...
								ILoggerCollector $loggerCollector
								) {
	...
	public function fileRestore($path) {
		...
		/**
	 * Store the create hook events
	 * @param array $param Path of the file that has been created
	 */
	public function fileCreateLog($param) {
		$this->addLogAction('File created','path='.$param['path'],"VSHARE");
	}

	/**
	 * Store the update hook events
	 * @param array $param  Path of the file that has been modified
	 */
	public function fileUpdateLog($param) {
		$this->addLogAction('File updated','path='.$param['path'],"VSHARE");
	}

	/**
	 * Store the delete hook events
	 * @param array $param  Path of the file that has been deleted
	 */
	public function fileDeleteLog($param) {
		$this->addLogAction('File deleted','path='.$param['path'],"VSHARE");
	}

	/**
	 * Store the restore hook events
	 * @param array $param  Path of the file that has been restored
	 */
	public function fileMoveLog($param) {
		$this->addLogAction('File move','oldpath='.$param['oldpath'].' newpath='.$param['newpath'],"VSHARE");
	}
	 ...
	 * @param array $param  Path of the file that has been restored
	 */
	public function fileMovedLog($param) {
		$this->addLogAction('File moved','oldpath='.$param['oldpath'].';newpath='.$param['newpath'],"VSHARE");
	}
	 ...
	 * @param array $param  Path of the file that has been restored
	 */
	public function fileRestoreLog($param) {
		$this->addLogAction('File restored','filePath='.$param['filePath'],"VSHARE");
	}

/**
	 * Store the restore hook events
	 * @param array $param The hook params
	 */
	public  function copyLog($param) {
		$this->addLogAction('File copied','oldpath='.$param['oldpath'].';newpath='.$param['newpath'],"VSHARE");
	}
	...
	public  function writeLog($param) {
		$this->addLogAction('File write','path='.$param['path'],"VSHARE");
	}
	 ...
	 * @param array $param The hook params
	 */
	public  function readLog($param) {
		$this->addLogAction('File read','path='.$param['path'],"VSHARE");
	}
	 ...
	 * @param array $param The hook params
	 */
	public  function shared($param) {
		$this->addLogAction('File shared','itemType='.$param['itemType'].' path='.$param['fileSource'],"VSHARE");
	}
	/**
	 * Store the create hook events
	 * @param array $param The hook params
	 */
	public  function unshared($param) {
		$this->addLogAction('File unshared','itemType='.$param['itemType'].' path='.$param['fileSource'],"VSHARE");
	}
	/**
	 * Store the create hook events
	 * @param array $param The hook param
	 */
	public  function updatePermissions($param) {
		$this->addLogAction('File update permissions','itemType='.$param['itemType'].' path='.$param['path'].' permissions='.$param['permissions'],"VSHARE");
	}
	/**
	 * Store the create hook events
	 * @param array $param The hook param
	...
	public  function updatePassword($param) {
		$this->addLogAction('File update password','itemType='.$param['itemType'].' source='.$param['itemSource'].' owner='.$param['uidOwner'],"VSHARE");
	}
	/**
	 * Store the create hook events
	 * @param array $param The hook param
	 */
	public  function updateExpirationDate($param) {
		$this->addLogAction('File update expiration date','itemType='.$param['itemType'].' source='.$param['itemSource'].' date='.$param['date'],"VSHARE");
	}
	/**
	 * Store the create hook events
	 * @param array $param The hook param
	 */
	public  function shareAccessed($param) {
		$this->addLogAction('File share accessed','itemType='.$param['itemType'].' token='.$param['token'].' owner='.$param['uidOwner'],"VSHARE");
	}
...
/**
	...
	public function userCreate($param) {
		...
		$this->addLogAction('User created','user='.$param['uid'],"VSHARE");
		 
		}catch (\Throwable $th) {
                        \OC::$server->getLogger()->error('[LOGCOLLECTOR] Error: ' . $th->getMessage());
                }
	}

	/**
	 * Store the create hook events
	 * @param array $param Path of the file that has been delete
	 */
	public  function userDelete($param) {
		 try {
		$this->addLogAction('User deleted','user='.$param['uid'],"VSHARE");
	...
	/**
	 * Store the create hook events
	 * @param array $param change
	 */
	public  function userChange($param) {
	    try {
	/** @var IUser $user */
		$user = isset($param['user']) ? $param['user'] : null;
		$feature = isset($param['feature']) ? $param['feature'] : null;
		$newValue = isset($param['value']) ? $param['value'] : null;
		...
		$this->addLogAction('User change','user='.$user->getUID().' feature='.$param['feature'].' value='.$param['value'],"VSHARE");
	    }catch (\Throwable $th) {
                        \OC::$server->getLogger()->error('[LOGCOLLECTOR] Error: ' . $th->getMessage());
                }
	}
	 ...
	 /**
	 * Store the create hook events
	 * @param array $param  passphrase
	 */
	public  function setPassphrase($param) {
		$this->addLogAction('Set passphrase','user='.$param['uid'],"LOGIN");
	}
	 ...
	 * @param array $param Path of the file that has been created
	 */
	public  function preSetPassphrase($param) {
		$this->addLogAction('Pre set passphrase','user='.$param['uid'],"LOGIN");
	}
	 ...
	 * @param array $param Path of the file that has been created
	 */
	public  function postPasswordReset($param) {
		$this->addLogAction('Post password  reset','user='.$param['uid'],"LOGIN");
	}
	 ...
	 * @param array $param Path of the file that has been created
	 */
	public  function prePasswordReset($param) {
		$this->addLogAction('Password reset','user='.$param['uid'],"LOGIN");
	}
	...
	public  function preLogin($param) {
		$this->addLogAction('Login attempt','Login attempt user='.$param['uid'],"LOGIN");
	}
	...
	public  function postLogin($param) {
		$this->addLogAction('Login successful','Login successful user='.$param['uid'],"LOGIN");
	}
	...
	public  function logout($param) {
		$this->addLogAction('Logout','Logout occurred',"LOGOUT");
	}
	 ...
	 * @param array $param Path of the file that has been created
	 */
	public  function loginFailed($param) {
		//$this->addLogAction('Login','Login failed user:'.$param['uid'],"LOGIN");
	}
	 ...
	 *
	 * @param string $activityType         The file that is being changed         The subject for the actor
	 * @param string $value        The subject for other users (with "by $actor")
	 */
	protected function addLogAction($activityType, $value, $app) {
		...
		if (!empty($addressId)) {
			$this->loggerCollector->collector($activityType,$value,$app); 
		}
