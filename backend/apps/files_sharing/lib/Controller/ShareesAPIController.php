...
class ShareesAPIController extends OCSController {
	...
	public function search(string $search = '', string $itemType = null, int $page = 1, int $perPage = 200, $shareType = null, bool $lookup = true): DataResponse {
		...
		//Apply hack for custom iterative permissions
		if (true === $this->iterativeSearch) {
			$vdeskPermissionManager = new VdeskPermissionManager() ;
			$nodeId = (int) $this->request->getParam('nodeId',-1);
			$this->result = $vdeskPermissionManager->getAvailableUsers($this->result,$nodeId,$this->userId);
		}
	...
	/**
	 * Get the value of iterativeSearch
	 */ 
	public function getIterativeSearch()
	{
		return $this->iterativeSearch;
	}

	/**
	 * Set the value of iterativeSearch
	 *
	 * @return  self
	 */ 
	public function setIterativeSearch($iterativeSearch)
	{
