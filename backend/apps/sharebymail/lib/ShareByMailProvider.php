...
// 				['token' => $share->getToken()]);
				$link = rtrim($this->config->getSystemValue('frontend.overwrite.url'), '/') . '/'.$share->getNodeId();
	...
	protected function sendMailNotification($filename,
		...
		$emailTemplate->setSubject($this->l->t('%1$s shared File or Folder with you »%2$s«', array($initiatorDisplayName, $filename)));
		$emailTemplate->addHeader();
		$emailTemplate->addHeading($this->l->t('%1$s shared File or Folder with you »%2$s«', [$initiatorDisplayName, $filename]), false);
		//$text = $this->l->t('%1$s shared with you »%2$s«', [$initiatorDisplayName, $filename]);
