...
use OCA\Wfam\Service\NotificheRuoloWfaService;


class NotificheRuoloWfaController extends Controller
{
    ...
    public function __construct($AppName, IRequest $request, NotificheRuoloWfaService $service)
    {
