...
use OCA\Wfam\Service\CategoriaWfaService;


class CategoriaWfaController extends Controller
{
    ...
    public function __construct($AppName, IRequest $request, CategoriaWfaService $service)
    {
