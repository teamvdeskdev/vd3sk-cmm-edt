...
use OCA\Wfam\Service\AzioneWfaService;


class AzioneWfaController extends Controller
{
    ...
    public function __construct($AppName, IRequest $request, AzioneWfaService $service)
    {
