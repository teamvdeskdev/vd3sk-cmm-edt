...
use OCA\Wfam\Service\ValoreElementoWfaService;


class ValoreElementoWfaController extends Controller
{
    ...
    public function __construct($AppName, IRequest $request, ValoreElementoWfaService $service)
    {
